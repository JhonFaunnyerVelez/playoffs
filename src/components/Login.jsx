  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-10 rounded-[3rem] shadow-2xl max-w-md w-full relative z-10 animate-fade-in text-center flex flex-col items-center">
        ...
        {error && (
          <div className="bg-red-500/10 border border-red-500/50 text-red-400 px-4 py-2 rounded-xl text-sm font-bold mb-6 w-full">
            {error}
          </div>
        )}
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white text-slate-900 font-black py-4 rounded-2xl hover:bg-slate-100 transition-all active:scale-95 shadow-xl hover:shadow-white/20 disabled:opacity-70 disabled:pointer-events-none"
        >
          {loading ? (
